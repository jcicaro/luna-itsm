(function () {
    ...
    controller("LunaController", function ($scope, $http, $sce, $location) {
        var c = this;
        ...
        loadCtrlMethods();
        c.log('c.pathname', c.pathname);

        // Code below commented while developing templates
        ...
        function loadCtrlMethods() {
            ...
            c.fetchPosts = function(recordType /* 'posts', 'pages', etc */) {
            ...
            c.fetchPage = function(slug) {
                ...
                c.showSpinner = true;
                return $http({ method: 'GET', url: c.siteUrl + '/wp-json/wp/v2/pages/?_embed&slug=' + slug }).
                    then(function (response) {
            ...
            c.fetchCategories = function() {
                ...
                c.showSpinner = true;
                return $http({ method: 'GET', url: c.siteUrl + '/wp-json/wp/v2/categories?per_page=' + c.maxCategoryResults }).
                    then(function (response) {
